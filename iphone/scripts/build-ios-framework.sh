...
NU_SDK_SRC=$NU_SDK_ROOT/framework
...
NU_SDK_BINARY_NAME=ZXingWidget
NU_SDK_TARGET_NAME=ZXingWidget
...
$LIPO \
  -create \
    $NU_SDK_BUILD/${BUILDCONFIGURATION}-iphonesimulator/lib$NU_SDK_TARGET_NAME.a \
    $NU_SDK_BUILD/${BUILDCONFIGURATION}-iphoneos/lib$NU_SDK_TARGET_NAME.a \
...
\cp \
  $NU_SDK_BUILD/${BUILDCONFIGURATION}-iphoneos/usr/local/include/*.h \
